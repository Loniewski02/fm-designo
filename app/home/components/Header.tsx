...
const Header = () => {
  ...
  return (
    <header className="md:sectionX headerY">
      <Wrapper className="sectionX md:rounded-15 relative flex flex-col items-center overflow-hidden bg-Peach pt-[80px] lg:px-24 lg:py-[145px]">
        ...
        <div className="z-10 flex w-full max-w-[327px] flex-col items-center text-center text-White md:max-w-none  lg:items-start lg:text-left">
          <h1 className="text-32 mb-[14px] font-medium md:mb-6 md:max-w-[573px] md:text-5xl lg:max-w-[540px]">
            Award-winning custom designs and digital branding solutions
          </h1>
          <p className="text-15 mb-6 md:max-w-[445px] md:text-base lg:px-0">
